# Template réponses QCM — Formation 4
...
## QCM J[X] — [Titre de la journée]

> Remplacer [X] et [Titre] selon le fichier qcm-Jx.md correspondant.
...
*Score estimé : [X]/8 — à faire corriger par Copilot*
